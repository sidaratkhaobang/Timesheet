...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?php echo $this->uri->segment(2) == 'assign' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>Leader_ctrl/assign"><i class="fas fa-user-friends"></i></i><span>Assignment</span></a></li>
        </ul>
    </aside>
</div>