          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <form action="<?php echo base_url() ?>login_ctrl/update_password" method="POST">
                  <div class="form-group">
                    ...
                    <?php } ?>
                    <input id="email" type="email" value="<?php echo (isset($email)) ? $email : '';?>" class="form-control" name="email" tabindex="1" required autofocus>
                  </div>
